...
export default function Home(){
  ...
  return <main className="min-h-screen bg-[#07111f] text-slate-100"><div className="mx-auto max-w-6xl px-4 pb-20 pt-5 sm:px-6">
    ...
    {data&&<AnalysisScreen data={data} activeHorse={activeHorse} danger={danger} onHorse={(horse)=>setActiveHorse(current=>current?.number===horse.number?null:horse)}/>} 
  </div></main>;
}
...
function AnalysisScreen({data,activeHorse,danger,onHorse}:{data:Analysis;activeHorse:Horse|null;danger:Horse|undefined;onHorse:(horse:Horse)=>void}){
